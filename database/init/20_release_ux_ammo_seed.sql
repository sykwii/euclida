...
('M231 MACS', 'modular', 'модуль', 'modular', 2, 2, 'Модульний заряд. Зона не дорівнює автоматично кількості модулів; правило задається конфігурацією.'),
('M232 MACS', 'modular', 'модуль', 'modular', 5, 5, 'Модульний заряд. Списання через конфігурацію.'),
('M232A1 MACS', 'modular', 'модуль', 'modular', 5, 5, 'Модульний заряд. Списання через конфігурацію.'),
